...
import jacobPic from "../public/img_gallery/jacobii.png";
...
const BandMembers: React.FC = () => {
  const members: Member[] = [
    {
      name: "Rance Chambers aka Ranci/Drummie",
    ...
    {
      name: "Phil Soltau aka PhilOssaffa",
    ...
    {
      name: "Hughlander Hepburn aka Rage",
    ...
    },
    {
      ...
      description: "Congo Drums/Precussions/vocals",
    ...
    {
      name: "Jacob Cammock aka Jakie/Guitsy",
    ...
    {
      name: "Sylvester Fyffe aka Bassie",
